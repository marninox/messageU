...
namespace ProtocolCodes {
    const uint8_t REGISTRATION_REQUEST = 1000;
    const uint8_t REGISTRATION_SUCCESS = 1001;
    const uint8_t REGISTRATION_FAILURE = 1002;
    const uint8_t LOGIN_REQUEST = 2000;
    const uint8_t LOGIN_SUCCESS = 2001;
    const uint8_t LOGIN_FAILURE = 2002;
    const uint8_t SEND_MESSAGE_REQUEST = 3000;
    const uint8_t SEND_MESSAGE_SUCCESS = 3001;
    const uint8_t SEND_MESSAGE_FAILURE = 3002;
    const uint8_t REQUEST_MESSAGES = 4000;
    const uint8_t MESSAGES_RESPONSE = 4001;
    const uint8_t REQUEST_USERS = 5000;
    const uint8_t USERS_RESPONSE = 5001;
    const uint8_t LOGOUT_REQUEST = 6000;
    const uint8_t LOGOUT_SUCCESS = 6001;
}
...
namespace ProtocolSizes {
    ...
    const uint16_t ERROR_MESSAGE_SIZE = 255;
